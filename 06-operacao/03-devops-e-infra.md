...
Raspagem, ETL, NLP, migrations da carga e os 37 testes de integridade do DW ficam
...
consultas". Os 37 testes SQL validam os dados no processo separado de carga manual.
...
5. **Nada sobe para produção sem os 37 testes de integridade vazios.**
